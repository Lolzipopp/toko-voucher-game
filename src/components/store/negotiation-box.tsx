...
export default function NegotiationBox({
  ...
  return (
    <section className="mt-5 rounded-3xl border border-amber-300/25 bg-amber-300/[.07] p-5">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div>
          ...
          <input
            ...
            className="w-full rounded-2xl border border-white/10 bg-[#06111f] px-4 py-3 text-sm text-white outline-none focus:border-amber-300/50 focus:ring-4 focus:ring-amber-300/10"
          />
        </div>
      ...
      <button
        ...
        className="mt-4 w-full rounded-2xl bg-amber-300 px-5 py-3.5 text-sm font-black text-amber-950 transition hover:bg-amber-200 disabled:cursor-not-allowed disabled:opacity-45"
      >
