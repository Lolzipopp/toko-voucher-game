    ...
    <footer className="border-t border-emerald-950/10 bg-[#0d2f23] pb-20 text-white md:pb-0">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-5 max-w-sm text-sm leading-7 text-white/60">Toko produk digital akun game dengan spesifikasi, harga, ketersediaan, dan ketentuan garansi yang ditampilkan sebelum pembelian.</p>
        </div>
        <div>
